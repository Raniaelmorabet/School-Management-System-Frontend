                ...
                <div id="printableTable">
                    <div className="overflow-x-auto">
                        ...
                        <div className='pb-4 justify-center text-center font-bold text-sm'>
                            ...
                            <i>Filière de Formation</i> : Développement informatique - 2ème année – Niveau : Technicien spécialisé
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        La moyenne générale de la première année représente la moyenne pondérée qui constitue seulement
                        le seuil minimal de passage en deuxième année qui doit être ≥ 10/20, Si cette moyenne est
                        comprise entre 08/20 et 10/20, le jury d’examens examine la situation des stagiaires concernés
                        et propose au Secrétariat d’Etat chargé de la Formation Professionnelle, les propositions pour :<br/>
                        <ul style={{listStyleType: 'disc', marginLeft: '20px'}}>
                            <li>Soit permettre au stagiaire de passer en deuxième année (rachat) ;</li>
                            <li>Soit autoriser le stagiaire à redoubler (une seule fois durant la durée de la filière de
                                formation) ;
                            </li>
